#Fájl megnyitása és bezárása context manager-rel 
autok = []
...
print(f"A legidősebb autó kora: {legidosebb_auto_kor}")
...
print(f"A legfiatalabb autó kora: {legfiatalabb_auto_kor}")
